export const AG_GRID_LOCALE_FA = {
    ...
    selectAllSearchResults: '(انتخاب همه برای نتایج جستجو)',
    searchOoo: 'جستجو...',
    blanks: '(خالی)',
    ...
    blank: 'خالی',
    notBlank: 'خالی نباشد',
    empty: 'یک مورد انتخاب کنید',

    // Number Filter
    lessThan: 'کمتر از',
    greaterThan: 'بزرگ تر از',
    lessThanOrEqual: 'برابر یا کمتر از',
    greaterThanOrEqual: 'برابر یا بزرگتر از',
    inRange: 'در بازه',
    inRangeStart: 'از',
    inRangeEnd: 'تا',
    ...
    // Text Filter
    contains: 'شامل',
    notContains: 'نباشد در داخل محتوا',
    startsWith: 'شروع با',
    endsWith: 'پایان با',
